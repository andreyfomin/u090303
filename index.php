...
if (LANG == 'ru')
{
	...
	$msg['desc'] = "
		...
		<br>
		<br>
		Система оптимально сконфигурирована и готова к использованию \"1С-Битрикс: Управление сайтом\", \"1С-Битрикс: Энтерпрайз\" и \"1С-Битрикс24\".<br>
		<br>
...
{	
	...
	$msg['desc'] = "
		Herzlich willkommen bei der virtuellen Maschine VMBitrix!<br>
 		<br>
		<br>
		Das System ist für die Verwendung von \"Bitrix24\" und \"Bitrix Site Manager \" optimal konfiguriert und einsatzbereit\".<br>
 		<br>
...
else
{
	...
	$msg['desc'] = "
		...
		<br>
		<br>
		System is optimally configured and is ready to be used with \"Bitrix Site Manager\" and \"Bitrix24\".<br>
		<br>
